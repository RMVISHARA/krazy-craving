...
$(document).ready(function () {
    ...
    allVendors = (allVendors) ? JSON.parse(allVendors) : [{
        ...
        },
        {
            ...
            'menu': [{
                    'id': '6',
                    'imageurl': '../../Assets/img/sohaniRice.jpg',
                    'name': 'Rice & Curry',
                    'price': '150',
                    'rating': '4.0'
                },
                {
                    'id': '7',
                    'imageurl': '../../Assets/img/sohaniChickenKottu.jpg',
                    'name': 'Chicken Kottu',
                    'price': '400',
                    'rating': '4.1'
                },
                {
                    'id': '8',
                    'imageurl': '../../Assets/img/sohaniVegeKottu.jpeg',
                    'name': 'Vegi Kottu',
                    'price': '300',
                    'rating': '4.1'
                },
                {
                    'id': '9',
                    'imageurl': '../../Assets/img/sohaniCheeseKottu.jpg',
                    'name': 'Cheese Kottu',
                    'price': '550',
                    'rating': '4.2'
                },
                {
                    'id': '10',
                    'imageurl': '../../Assets/img/sohaniBiriyani.jpg',
                    'name': 'Biriyani',
                    'price': '800',
                    'rating': '4.5'
                }
