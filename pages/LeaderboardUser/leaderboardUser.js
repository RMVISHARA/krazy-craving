$(document).ready(function() 
{
    ...
    for (let i = 0; i < 20; i++)
    {
        ...
        if( i != 10 ){
            users.push({ bgcolor: "ffffff", rank: i+10, image: "../../Assets/img/boy.jpg", name: "Jhon Doe", points: points});
        }else{
            users.push({ bgcolor: "fc9920", rank: i+10, image: "../../Assets/img/boy2.jpg", name: "Udara Nayana", points: points})
        }
